...
namespace xop {
  ...
  public:
    ...
    // SDP Session Name
    virtual void SetVersion (std::string version)  { version_ = std::move(version); }
  ...
  protected:
    ...
    virtual MediaSession::Ptr LookMediaSession (const std::string& suffix) { return nullptr; }
    virtual MediaSession::Ptr LookMediaSession (MediaSessionId sessionId) { return nullptr; }
